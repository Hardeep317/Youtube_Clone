  ...
  return (
    <Box width={"95%"} m="auto" position="fixed" alignContent="center" backgroundColor={"black"}>
        <Stack zIndex="1" direction={[ 'row']} spacing="auto">
           ...
           <Button  onClick={onOpen} ref={btnRef} variant="unstyled"><HamburgerIcon color={"white"} fontSize={["18px","16px","19px","25px"]}/></Button> 
           <Drawer
          isOpen={isOpen}
          placement='left'
          onClose={onClose}
    ...
    _placeholder={{ opacity: 1, color: 'gray' }} color="white" fontSize={["12px","11px","14px","17px"]} padding={["4px 4px","4px 9px","6px 13px","8px 18px"]} border="1px solid grey"  borderTopLeftRadius={"30px"}borderBottomStartRadius="30px" borderTopEndRadius="0px" borderBottomEndRadius="0px" width={["80px","150px","250px","400px"]}/>

                <Button variant="unstyled" display="flex" onClick={handleClick} justifyContent="center" alignItems="center" height= {["30px","30px","35px","44px"]}  fontSize={["9px","17px","18px","28px"]}  margin="auto" fontWeight="300" color={"white"}   borderRadius="0px" width={["10px","25px","35px","50px"]} backgroundColor="#0F0E0D " borderTopRightRadius={["10px","20px","25px","30px"]} borderBottomRightRadius={["10px","20px","25px","30px"]} ><IoIosSearch /></Button>

                <Button variant="unstyled" backgroundColor="#0F0E0D " display="flex" fontSize={["9px","17px","18px","28px"]} height= {["30px","30px","35px","44px"]} alignItems="center"  borderRadius="100%" width={["10px","25px","35px","50px"]} justifyContent="center"  ml={["2px","5px","7px","10px"]} ><BsMicFill  color='white'/></Button>
            </Box>
